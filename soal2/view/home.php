    ...
    <table class="table" border=1>
        ...
        foreach($alldata as $d){ ?>
            <tr>
                ...
                <td><?=$d->alamat?></td>
                <td>
                    <a class="btn btn-warning" href="index.php?action=form-edit&nomor_induk=<?=$d->nomor_induk;?>">Edit</a>
                    <a class="btn btn-danger" href="index.php?action=delete&nomor_induk=<?=$d->nomor_induk;?>">Delete</a>
                </td>
            </tr>
        <?php };
